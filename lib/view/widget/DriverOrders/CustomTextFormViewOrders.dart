...
class CustomTextFormViewOrders extends StatelessWidget {
  final String label_;
 ...
 final void Function(String)? onChanged_;
  ...
  const CustomTextFormViewOrders({
         super.key, 
      ...
      child: TextFormField(
        ...
        FilteringTextInputFormatter.singleLineFormatter
                      ...
                      decoration:
                         ...
                         label: Text(label_, style: TextStyle(color: Colors.black,fontSize: 15, fontWeight: FontWeight.bold),),
                         hintText: hintText_,
